    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            <div className={`fixed inset-y-0 left-0 w-64 bg-white shadow-lg transform transition-transform duration-200 ease-in-out z-30 
                ...
                <div className="h-16 flex items-center justify-between px-4 border-b bg-backgroundSecondary">
                    <span className="text-xl font-semibold text-secondary">{productName}</span>
                    <button
                        onClick={toggleSidebar}
